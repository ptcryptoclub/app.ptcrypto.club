function historical_line_advanced(divName) {
    ...
    chart.dataSource.events.on("done", function (ev) {
        ...
        divElement.innerHTML = '<div class="p-xl-3 p-lg-3 p-md-3 p-sm-2 p-2 border border-' + color + ' rounded-lg mt-3"><div class="text-light text-center small">Showing data from ' + minDate.toString().slice(0, 24) + ' to ' + maxDate.toString().slice(0, 24) + '</div><div class="row no-gutters justify-content-around"><div class="col-md-auto mt-3 align-self-center"><div class="row no-gutters"><div class="col-auto p-1"><div class="text-' + color + '"><H2>' + diffPercentage.toFixed(2) + '%</H2></div><div class="small text-' + color + ' text-center"><small>' + numberFormat(diffAbsolute.toFixed(2)) + ' ' + quote.toUpperCase() + '</small></div></div><div class="col p-1"><span class="material-icons text-' + color + '" style="font-size:60px">' + arrow + '</span></div></div></div><div class="col-md-auto mt-3"><div class="row no-gutters justify-content-around"><div class="col-auto"><div class="text-center text-muted mb-1">Start</div><div class="text-center"><H5 class="text-light">' + numberFormat(minDateValue) + ' ' + quote.toUpperCase() + '</H5></div></div><div class="col-auto ml-3"><div class="text-center text-muted mb-1">End</div><div class="text-center"><H5 class="text-light">' + numberFormat(maxDateValue) + ' ' + quote.toUpperCase() + '</H5></div></div></div></div></div></div>'
...
function historical_ohlc_advanced(divName) {
    ...
    if (start == "" & end == "") {
        urlToSend = "/api/historical-charts/ohlc/" + base + "/" + quote + "/" + market + "/900/" + apiSecret +"/"
    } else if (start != "" & end == "") {
        urlToSend = "/api/historical-charts/ohlc/" + base + "/" + quote + "/" + market + "/900/" + apiSecret +"/?start="+ start;
    }else if (end != "" & start == "") {
        urlToSend = "/api/historical-charts/ohlc/" + base + "/" + quote + "/" + market + "/900/" + apiSecret +"/?end="+ end;
    } else {
        urlToSend = "/api/historical-charts/ohlc/" + base + "/" + quote + "/" + market + "/900/" + apiSecret +"/?start="+ start +"&end=" + end;
    }
...
function historical_vtp_advanced(divName) {
    var start = document.getElementById("start-advanced").value;
    var end = document.getElementById("end-advanced").value;
    ...
    if (start == "" & end == "") {
        urlToSend = "/api/historical-charts/vtp/" + base + "/" + quote + "/" + market + "/1800/" + apiSecret +"/"
    } else if (start != "" & end == "") {
        urlToSend = "/api/historical-charts/vtp/" + base + "/" + quote + "/" + market + "/1800/" + apiSecret +"/?start="+ start;
    }else if (end != "" & start == "") {
        urlToSend = "/api/historical-charts/vtp/" + base + "/" + quote + "/" + market + "/1800/" + apiSecret +"/?end="+ end;
    } else {
        urlToSend = "/api/historical-charts/vtp/" + base + "/" + quote + "/" + market + "/1800/" + apiSecret +"/?start="+ start +"&end=" + end;
    }
